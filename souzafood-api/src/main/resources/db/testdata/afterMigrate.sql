...
insert into permissao (id, nome, descricao) values (4, 'EDITAR_COZINHAS', 'Permite editar cozinhas');
insert into permissao (id, nome, descricao) values (5, 'CONSULTAR_FORMAS_PAGAMENTO', 'Permite consultar formas de pagamento');
insert into permissao (id, nome, descricao) values (6, 'EDITAR_FORMAS_PAGAMENTO', 'Permite criar ou editar formas de pagamento');
insert into permissao (id, nome, descricao) values (7, 'CONSULTAR_CIDADES', 'Permite consultar cidades');
insert into permissao (id, nome, descricao) values (8, 'EDITAR_CIDADES', 'Permite criar ou editar cidades');
insert into permissao (id, nome, descricao) values (9, 'CONSULTAR_ESTADOS', 'Permite consultar estados');
insert into permissao (id, nome, descricao) values (10, 'EDITAR_ESTADOS', 'Permite criar ou editar estados');
insert into permissao (id, nome, descricao) values (11, 'CONSULTAR_USUARIOS', 'Permite consultar usuários');
insert into permissao (id, nome, descricao) values (12, 'EDITAR_USUARIOS', 'Permite criar ou editar usuários');
insert into permissao (id, nome, descricao) values (13, 'CONSULTAR_RESTAURANTES', 'Permite consultar restaurantes');
insert into permissao (id, nome, descricao) values (14, 'EDITAR_RESTAURANTES', 'Permite criar, editar ou gerenciar restaurantes');
insert into permissao (id, nome, descricao) values (15, 'CONSULTAR_PRODUTOS', 'Permite consultar produtos');
insert into permissao (id, nome, descricao) values (16, 'EDITAR_PRODUTOS', 'Permite criar ou editar produtos');
insert into permissao (id, nome, descricao) values (17, 'CONSULTAR_PEDIDOS', 'Permite consultar pedidos');
insert into permissao (id, nome, descricao) values (18, 'GERENCIAR_PEDIDOS', 'Permite gerenciar pedidos');
insert into permissao (id, nome, descricao) values (19, 'GERAR_RELATORIOS', 'Permite gerar relatórios');
...
(1, 'João da Silva', 'joao.ger@algafood.com.br', '$2a$12$Qo1DoAKQPRPUdHC4Ks1VdOSeN.9nakN3H5vmdsHRBty7EULXVXKpu', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com.br', '$2a$12$Qo1DoAKQPRPUdHC4Ks1VdOSeN.9nakN3H5vmdsHRBty7EULXVXKpu', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com.br', '$2a$12$Qo1DoAKQPRPUdHC4Ks1VdOSeN.9nakN3H5vmdsHRBty7EULXVXKpu', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@algafood.com.br', '$2a$12$Qo1DoAKQPRPUdHC4Ks1VdOSeN.9nakN3H5vmdsHRBty7EULXVXKpu', utc_timestamp),
(5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2a$12$Qo1DoAKQPRPUdHC4Ks1VdOSeN.9nakN3H5vmdsHRBty7EULXVXKpu', utc_timestamp),
(6, 'Rodrigo Souza', 'rdsouza.c@gmail.com', '$2a$12$Qo1DoAKQPRPUdHC4Ks1VdOSeN.9nakN3H5vmdsHRBty7EULXVXKpu', utc_timestamp),
(7, 'Rodrigues Souza', 'rdg.cs33@gmail.com', '$2a$12$Qo1DoAKQPRPUdHC4Ks1VdOSeN.9nakN3H5vmdsHRBty7EULXVXKpu', utc_timestamp);
