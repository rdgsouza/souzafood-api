...
//Aulas que ensinam como criar a lista abaixo que pega o nome de cada propiedade que teve violação		    
//Aula: https://www.algaworks.com/aulas/1952/estendendo-o-problem-details-para-adicionar-as-propriedades-com-constraints-violadas
//Aula: https://www.algaworks.com/aulas/1966/ajustando-exception-handler-para-adicionar-mensagens-de-validacao-em-nivel-de-classe
...
//		ex.printStackTrace();
	...
	public ResponseEntity<Object> handleValidacaoException(ValidacaoException ex, WebRequest request) {
	    return handleValidationInternal(ex, new HttpHeaders(), 
	            HttpStatus.BAD_REQUEST, request, ex.getBindingResult());
	}    
	...
	private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex, 
		...
		ProblemType problemType = ProblemType.MENSAGEM_INCOMPREENSIVEL;
		String detail = String.format(
				"A propriedade '%s' não existe. " + "Corrija ou remova essa propriedade e "
						+ "tente novamente.", path);
